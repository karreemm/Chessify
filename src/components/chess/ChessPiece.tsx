...
export function ChessPiece({ piece, color, size = 45, className = '' }: ChessPieceProps) {
      ...
      k: (
        <svg viewBox="0 0 45 45" width={size} height={size} className={className}>
          <g style={{ fill: 'none', fillOpacity: 1, fillRule: 'evenodd', stroke: '#000000', strokeWidth: 1.5, strokeLinecap: 'round', strokeLinejoin: 'round', strokeMiterlimit: 4, strokeDasharray: 'none', strokeOpacity: 1 }}>
            ...
            <path d="M 25 8 A 2.5 2.5 0 1 1  20,8 A 2.5 2.5 0 1 1  25 8 z" style={{ fill: 'none', stroke: '#000000' }} />
          </g>
        </svg>
      ),
      q: (
      ...
      b: (
        <svg viewBox="0 0 45 45" width={size} height={size} className={className}>
          <g style={{ opacity: 1, fill: 'none', fillRule: 'evenodd', fillOpacity: 1, stroke: '#000000', strokeWidth: 1.5, strokeLinecap: 'round', strokeLinejoin: 'round', strokeMiterlimit: 4, strokeDasharray: 'none', strokeOpacity: 1 }}>
            ...
            <path d="M 17.5,26 L 27.5,26 M 15,30 L 30,30 M 25 16 A 2.5 2.5 0 1 1  20,16 A 2.5 2.5 0 1 1  25 16 z" style={{ fill: 'none', stroke: '#000000', strokeLinejoin: 'miter' }} />
          </g>
        </svg>
      ),
      n: (
  ...
  const svgs: Record<string, JSX.Element> = {
    k: (
      <svg viewBox="0 0 45 45" width={size} height={size} className={className}>
        <g style={{ fill: 'none', fillOpacity: 1, fillRule: 'evenodd', stroke: '#000000', strokeWidth: 1.5, strokeLinecap: 'round', strokeLinejoin: 'round', strokeMiterlimit: 4, strokeDasharray: 'none', strokeOpacity: 1 }}>
          <path d="M 22.5,25 C 22.5,25 27,17.5 25.5,14.5 C 25.5,14.5 24.5,12 22.5,12 C 20.5,12 19.5,14.5 19.5,14.5 C 18,17.5 22.5,25 22.5,25" style={{ fill: '#000000', strokeLinecap: 'butt', strokeLinejoin: 'miter' }} />
    ...
    b: (
      <svg viewBox="0 0 45 45" width={size} height={size} className={className}>
        <g style={{ opacity: 1, fill: 'none', fillRule: 'evenodd', fillOpacity: 1, stroke: '#000000', strokeWidth: 1.5, strokeLinecap: 'round', strokeLinejoin: 'round', strokeMiterlimit: 4, strokeDasharray: 'none', strokeOpacity: 1 }}>
          ...
          <path d="M 17.5,26 L 27.5,26 M 15,30 L 30,30 M 25 16 A 2.5 2.5 0 1 1  20,16 A 2.5 2.5 0 1 1  25 16 z" style={{ fill: 'none', stroke: '#ffffff', strokeLinejoin: 'miter' }} />
        </g>
      </svg>
    ),
    n: (
