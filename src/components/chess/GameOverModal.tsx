        ...
        <div className="space-y-6 py-4">
          <div className="grid grid-cols-2 gap-4">
            <div className="wood-panel rounded-lg p-4 text-center space-y-1">
              <div className="text-muted-foreground text-xs uppercase tracking-wider font-[Cinzel]">
                Total Moves
              </div>
          ...
          <div className="flex gap-3">
            ...
            <Button
              ...
              className="flex-1 font-[Cinzel] bg-transparent border-border hover:bg-primary/10 hover:text-primary"
            >
              New Game
            </Button>
            <Button
              ...
              size="icon"
              onClick={copyMoves}
              className="bg-transparent border-border hover:bg-primary/10 hover:text-primary"
              title="Copy moves"
            >
